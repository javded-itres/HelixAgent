...
```text
Найди в интернете HolixAgentAi на PyPI и скажи последнюю версию.
```
...
1. **План** — нумерованные шаги от LLM.
2. **Согласование** — при `plan_review_enabled=true` (по умолчанию):
...
3. **Выполнение** — каждый шаг с инструментами; после завершения — следующий шаг.
4. **Финал** — итог, когда все шаги готовы.
