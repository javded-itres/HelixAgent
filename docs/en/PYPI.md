...
> **Published:** [HelixAgentAi 0.1.8](https://pypi.org/project/HolixAgentAi/) — install with `pipx install HolixAgentAi`.
...
ls -la dist/
# holixagentai-0.1.0-py3-none-any.whl
# holixagentai-0.1.0.tar.gz
```
...
uv pip install --python /tmp/holix-test/bin/python dist/holixagentai-*.whl
...
```bash
pip install -i https://test.pypi.org/simple/ HolixAgentAi
```
